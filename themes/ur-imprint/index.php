<?php get_header(); ?>
	...
	==== HERO
	================================================== -->
	<section class="[ hero ][ padding ][ margin-bottom ]" style="background-image: url('images/background.jpg')">
		<div class="[ wrapper ]">
			<div class="[ text-center color-light ]">
				<div class="[ bg-logo__wrapper ]">
					<a class="[ bg-logo ]" href="#"></a>
				</div>
				<h2 class="[ text-shadow ]">Bring your imagination to life</h2>
			...
			<div class="[ row ]">
				<article class="[ square ][ bg-primary--darken-10 ]">
					<div class="[ square-content ][ color-light ]">
						<img class="[ svg icon icon--xxlarge ]" src="icons/hamburger.svg" alt="menu">
