<?php get_header(); ?>
	...
	<section class="[ faqs ]">
		<div class="[ wrapper ]">
			...
			<article class="[ general-faqs ][ margin-bottom--large ]">
				<?php
				$faq_counter = 1;
				$faq_args = array(
					'post_type' 		=> 'faq',
			...
			<article class="[ artwork-faqs ][ margin-bottom--large ]">
				<?php
				$faq_counter = 1;
				$faq_args = array(
					'post_type' 		=> 'faq',
			...
			<article class="[ design-tips-faqs ][ margin-bottom--large ]">
				<?php
				$faq_counter = 1;
				$faq_args = array(
					'post_type' 		=> 'faq',
			...
			<article class="[ delivery-faqs ][ margin-bottom--large ]">
				<?php
				$faq_counter = 1;
				$faq_args = array(
					'post_type' 		=> 'faq',
			...
			<article class="[ products-garments-sizes-faqs ][ margin-bottom--large ]">
				<?php
				$faq_counter = 1;
				$faq_args = array(
					'post_type' 		=> 'faq',
